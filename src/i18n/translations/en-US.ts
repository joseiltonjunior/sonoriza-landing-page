...
const enUS = {
  ...
  pioneers: {
    ...
    title: 'Anyone who joins now helps build the beginning.',
    intro:
      'Artists who take part in this initial Sonoriza phase may receive symbolic recognition as project pioneers, with a badge inside the app, the possibility of appearing in dedicated highlight spaces, and a special thank-you for trusting this early stage.',
    cards: [
      {
        title: 'Pioneer badge',
        text: 'A symbolic identification to mark the artists who trusted Sonoriza in the initial stage of the catalog.',
      },
      {
        title: 'Highlight area',
        text: 'Pioneers may be included in editorial highlight areas inside the app and in the project communication.',
      },
      {
        title: 'Symbolic thank-you',
        text: 'Beyond product recognition, the goal is to register this early participation with a symbolic thank-you item, subject to availability.',
      },
    ],
  },
  projectStory: {
    label: 'About the project',
    title: 'Who is behind Sonoriza.',
    name: 'Joseilton Ferreira Junior',
    role: 'Founder and developer of Sonoriza',
    badges: ['Recife, PE', 'Direct contact'],
    paragraphs: [
      'I am Joseilton Ferreira Junior, founder and developer of Sonoriza. I have worked with software development since 2020 and started building the project foundation in 2023, when a local music player evolved into something bigger. Today I lead Sonoriza end to end, from architecture to the final app experience, based in Recife, Pernambuco.',
      'At this stage, you speak directly with me about authorization, material delivery, curation, and catalog entry. The proposal is to grow with real artists in a close, transparent way, with room for the local and regional scene.',
    ],
    photoAlt: 'Photo of Joseilton Ferreira Junior',
    links: [
      { label: 'LinkedIn', href: 'https://www.linkedin.com/in/joseilton-junior/' },
      { label: 'Founder Instagram', href: 'https://www.instagram.com/dvlp.jr/' },
      { label: 'Sonoriza Instagram', href: 'https://www.instagram.com/sonoriza.sound/' },
    ],
  },
  howItWorks: {
    label: 'How it works',
    title: ['Simple. Transparent.', 'No fine print.'],
    steps: [
      {
        number: '01',
        icon: '✉',
        title: 'You get in touch',
        text: 'Fill out the form with your details and context. At this stage, the contact is directly with the founder to align authorization, catalog, and next steps.',
      },
      {
        number: '02',
        icon: '⚙',
        title: 'We align authorization and materials',
        text: 'After the first contact, we align the authorization and what needs to be sent: tracks, cover art, artist photo, genres, and basic catalog information.',
      },
      {
        number: '03',
        icon: '▶',
        title: 'Your catalog enters Sonoriza',
        text: 'Once everything is approved, ingestion is done manually and the authorized content becomes part of the Sonoriza catalog during the pilot phase.',
      },
      {
        number: '04',
        icon: '↻',
        title: 'You keep full control',
        text: 'Want to leave? Just ask. Your material is removed with no bureaucracy, no minimum term, and no questions.',
      },
    ],
  },
  model: {
    ...
    noItems: [
      'Music distributor (DistroKid, TuneCore)',
  ...
  faq: {
    ...
    body:
      'The goal here is to make clear what makes sense at this stage and what happens after you talk with Sonoriza.',
    items: [
      {
  ...
  contact: {
    ...
    form: {
      ...
      messageLabel: 'Message / short description',
      placeholders: {
        name: 'How people know you on stage',
        phone: '(xx) xxxxx-xxxx',
        email: 'you@email.com',
        message: 'Briefly describe your catalog, question, or proposal.',
      },
      reasonPlaceholder: 'Select',
      reasons: [
        { value: 'autorizar_catalogo', label: 'I want to authorize my catalog' },
        { value: 'saber_mais', label: 'I want to know more before deciding' },
        { value: 'remover_catalogo', label: 'I want to remove my catalog' },
        { value: 'outro', label: 'Another topic' },
      ],
      submitLabel: 'Send message',
      submittingLabel: 'Sending...',
      successTitle: 'Message received.',
      successText: ['We will get back to you soon.', 'Thanks for joining in from the beginning.'],
      fieldLabels: {
        name: 'artist name',
      ...
      errors: {
        requiredName: 'Fill in the artist name.',
        requiredPhone: 'Fill in the contact number.',
        invalidPhone: 'Enter a valid phone number with area code.',
        requiredEmail: 'Fill in the email.',
        invalidEmail: 'Enter a valid email.',
        requiredReason: 'Select the reason for contact.',
        requiredMessage: 'Briefly describe your request.',
        minMessage: 'The message must have at least 10 characters.',
        submitFallback: 'It was not possible to send right now. Please try again in a moment.',
      },
    },
  },
  footer: {
